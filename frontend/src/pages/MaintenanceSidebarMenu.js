...
export const MAINTENANCE_MENU = [
  ...
  { slug: 'other-charge-setup', label: 'Other Charge Setup', group: 4, path: '/job-orders/additional-charges/other-charge-setup' },
  { slug: 'lubricants-and-fuel', label: 'Lubricants  And Fuel', group: 4, path: '/job-orders/additional-charges/lubricants-and-fuel' },
  { slug: 'miscellaneous-charges', label: 'Miscellaneous Charges', group: 4, path: '/job-orders/additional-charges/miscellaneous-charges' },
  { slug: 'sublet-work-type', label: 'Sublet Work Type', group: 4, path: '/job-orders/additional-charges/sublet-work-type' },
