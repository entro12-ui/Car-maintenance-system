...
export default function GarageCashInvoice() {
  const invoiceType = 'Cash'
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Cash Invoice</h1>
        <p className="text-gray-600">Select a closed job order and print a cash invoice.</p>
      </div>
      ...
      <Card className="p-4">
        {isLoading ? (
          ...
          <div className="text-sm text-gray-500">No eligible closed jobs for cash invoicing.</div>
        ) : (
