...
export default function GarageCreditInvoice() {
  const invoiceType = 'Credit'
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">Credit Invoice</h1>
        <p className="text-gray-600">Select a closed job order and print a credit invoice.</p>
      </div>
      ...
      <Card className="p-4">
        {isLoading ? (
          ...
          <div className="text-sm text-gray-500">No eligible closed jobs for credit invoicing.</div>
        ) : (
