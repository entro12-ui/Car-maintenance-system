    ...
    >
      <div className="bg-white border rounded-lg shadow-sm">
        ...
        <div className="p-4 space-y-4">
          {tab === 'plate' && (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <label className="text-sm space-y-1">
                  <div className="font-medium text-gray-800">Reason / Remark</div>
                  <Input value={reason} onChange={(e) => setReason(e.target.value)} />
                </label>
              </div>
              <div className="border rounded-md p-3 bg-slate-50/60">
                <div className="text-sm font-semibold text-gray-800 mb-2">Block/Park For</div>
          ...
          {tab === 'customer' && (
            <div className="space-y-3">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                <label className="text-sm space-y-1">
                  <div className="font-medium text-gray-800">Tel. No</div>
                  <Input readOnly value={selectedCustomer?.phone || ''} />
                </label>
                <label className="text-sm space-y-1">
                  <div className="font-medium text-gray-800">Cell No</div>
                ...
                <label className="text-sm space-y-1">
                  <div className="font-medium text-gray-800">Account No</div>
                  <Input readOnly value={selectedCustomer?.sub_ledger || ''} />
                </label>
                <label className="text-sm space-y-1">
                  <div className="font-medium text-gray-800">Cust No</div>
                  <Input readOnly value={selectedCustomer ? String(selectedCustomer.customer_id) : ''} />
                </label>
                <label className="text-sm space-y-1 md:col-span-2">
                  <div className="font-medium text-gray-800">TIN</div>
          ...
          {tab === 'release' && (
            <div className="space-y-3">
              <p className="text-sm text-gray-600">Blocked job orders (latest 500 scan). Click Release to clear the flag.</p>
                ...
                <table className="min-w-[900px] w-full text-sm">
                  ...
                  <tbody>
                    {(blockedJobsQuery.data || []).map((j) => (
                      <tr key={j.job_order_id} className="border-b border-gray-100 hover:bg-gray-50">
          ...
          {history.length > 0 && (
            <div className="border-t pt-4 space-y-2">
              <div className="text-base font-semibold text-gray-900">Session history</div>
              <div className="overflow-auto">
                <table className="min-w-[900px] w-full text-sm">
                  <thead>
                    <tr className="text-left text-gray-600 border-b">
