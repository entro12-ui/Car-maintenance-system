...
class Employee(Base):
    ...
    work_unit = Column(String(120), nullable=True)
    supervisor_employee_id = Column(Integer, ForeignKey("employees.employee_id", ondelete="SET NULL"), nullable=True)
    can_dispatch_job = Column(Boolean, default=False)
    on_payroll = Column(Boolean, default=False)
    payroll_no = Column(String(40), nullable=True)
